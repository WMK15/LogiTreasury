      ...
      <div className="card">
        ...
        <div className="space-y-3 mb-4">
          {recipients.map((r, index) => (
            <div
              key={index}
              className="flex gap-2 items-center bg-neutral-800/30 p-2 rounded-md"
            >
              ...
              <input
                ...
                value={r.reference}
                onChange={(e) =>
                  updateRecipient(index, "reference", e.target.value)
                }
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <p className="text-sm tabular-nums">
            Total:{" "}
            <span className="text-neutral-100">{totalAmount.toFixed(2)}</span>{" "}
            USDC
          </p>
        </div>
      ...
      {myBatches && myBatches.length > 0 && (
        <div className="card mt-4">
          ...
          <p className="text-sm text-neutral-400">
            {myBatches.length} batches executed
          </p>
        </div>
      )}
    </div>
